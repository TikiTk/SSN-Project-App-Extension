...
import com.secuso.privacyFriendlyCodeScanner.decoding.HexStringConverter;
...
public class TextFragment extends ResultFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String decodedString =  hexStringConverter.hexToString(this.result);
        resultText.setText(decodedString);
